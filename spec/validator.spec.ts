...
describe("Fhir Validator jar", () => {
   ...
   beforeEach(function() {
    ...
    it("validates sample fhir object" , function (done) {
        ...
        const child=   exec('java -jar ./spec/data/org.hl7.fhir.validator.jar ./spec/data/resource.json', function (error, stdout,stderr) { //standard output of jar file is through stdout
    ...
    it("validates trialscope -> research study object", function(done){
        ...
        const child=   exec('java -jar ./spec/data/org.hl7.fhir.validator.jar ./spec/data/converted.json', function (error, stdout,stderr) { //standard output of jar file is through stdout
            console.log(`Output -> ${stdout}`);
            if (error !== null) {
                console.log(`Error ->  ${stderr}`);
            }
