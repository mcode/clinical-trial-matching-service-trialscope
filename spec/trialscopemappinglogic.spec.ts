...
describe('checkPrimaryCancerFilterLogic', () => {
  const createPrimaryCancerValues = (
    ...
    const mappingLogic = new TrialscopeMappingLogic(
  ...
  it('Test Breast Cancer Filter', () => {
    ...
    expect(createPrimaryCancerValues(coding, histologyMorphologyBehavior, clinicalStatus, undefined, undefined)).toBe(
      'BREAST_CANCER'
    );
  });
  ...
  it('Test Concomitant invasive malignancies Filter', () => {
    ...
    expect(createPrimaryCancerValues(coding, undefined, clinicalStatus, tnmClinical, undefined)).toBe(
  ...
  it('Test Locally Recurrent Filter', () => {
    const clinicalStatus = { system: 'snomed', code: 'recurrence', display: 'N/A' } as Coding;
    const coding = { system: 'http://snomed.info/sct', code: '783541009', display: 'N/A' } as Coding;
    expect(createPrimaryCancerValues(coding, undefined, clinicalStatus, undefined, undefined)).toBe(
      'LOCALLY_RECURRENT'
    );
  });
...
describe('checkSecondaryCancerFilterLogic', () => {
  const createSecondaryCancerValues = (
    secondaryCancerCondition: Coding,
    secondaryClinicalStatus: Coding,
    primaryCoding: Coding,
    primaryHistology: Coding,
    secondaryBodySite: Coding,
    tnmPathological: Coding
  ): string => {
  ...
  it('Test Brain Metastasis Filter', () => {
    ...
    expect(
      createSecondaryCancerValues(secondaryCoding, secondaryClinicalStatus, undefined, undefined, undefined, undefined)
    ).toBe('BRAIN_METASTASIS');
  });
  ...
  it('Test Invasive Breast Cancer and Metastatic Filter', () => {
    ...
    const primaryHistologyMorphologyBehavior = {
    ...
    expect(
      createSecondaryCancerValues(
        secondaryCoding,
        undefined,
        primaryCoding,
        primaryHistologyMorphologyBehavior,
        undefined,
        undefined
      )
    ).toBe('INVASIVE_BREAST_CANCER_AND_METASTATIC');
  });
  ...
  it('Test Leptomeningeal metastatic disease Filter', () => {
    ...
    expect(createSecondaryCancerValues(undefined, undefined, undefined, undefined, secondaryBodySite, undefined)).toBe(
      'LEPTOMENINGEAL_METASTATIC_DISEASE'
    );
  });
  ...
  it('Test Metastatic Filter', () => {
    ...
    const secondaryCoding = { system: 'http://snomed.info/sct', code: '285641009', display: 'N/A' } as Coding; // Any code
    expect(
      createSecondaryCancerValues(secondaryCoding, undefined, undefined, undefined, undefined, tnmPathological)
    ).toBe('METASTATIC');
  });
});

describe('checkHistologyMorphologyFilterLogic', () => {
  const createHistologyMorphologyResource = (
    primaryCoding: Coding,
    histologyBehavior: Coding,
    tnmClinicalStage: Coding,
    tnmPathologicalStage: Coding
  ): string => {
  ...
  it('Test Invasive Carcinoma Filter', () => {
    ...
    const histologyMorphologyBehavior = {
      system: 'http://snomed.info/sct',
      code: '734075007',
      display: 'N/A'
    } as Coding; // Any code in 'Morphology-Invasive_Carcinoma'
    expect(createHistologyMorphologyResource(coding, histologyMorphologyBehavior, undefined, undefined)).toBe(
      'INVASIVE_CARCINOMA'
    );
  });
  ...
  it('Test Invasive Mammory Carcinoma Filter 2', () => {
    ...
    expect(createHistologyMorphologyResource(primaryCoding, undefined, tnmClinicalStage, undefined)).toBe(
      'INVASIVE_MAMMORY_CARCINOMA'
    );
  });
  ...
  it('Test Invasive Mammory Carcinoma Filter 3', () => {
    ...
    expect(createHistologyMorphologyResource(primaryCoding, undefined, undefined, tnmPathological)).toBe(
      'INVASIVE_MAMMORY_CARCINOMA'
    );
  });
  ...
  it('Test Invasive Lobular Carcinoma Filter', () => {
    ...
    expect(createHistologyMorphologyResource(coding, undefined, undefined, undefined)).toBe(
...
describe('checkStageFilterLogic', () => {
  ...
  it('Test Invasive Breast Cancer and Locally Advanced Filter', () => {
    ...
    const bundle = createPrimaryCancerResource(
      primaryCoding,
      histologyMorphologyBehavior,
      primaryClinicalStatus,
      undefined,
      tnmPathological
    );
    const mappingLogic = new TrialscopeMappingLogic(bundle);
  ...
  it('Test Stage 2 Filter', () => {
    const stages = createTnmPathologicalBundle({
      system: 'snomed',
      code: 'Stage 2B (qualifier value)',
      display: 'N/A'
    } as Coding); // Any code in 'Stage-2'
...
describe('checkRadiationProcedureFilterLogic', () => {
  ...
  it('Test SRS Filter', () => {
    const radiationValue = createRadiationBundle(
      { system: 'http://snomed.info/sct', code: '473237008', display: 'N/A' } as Coding,
      undefined
    ); // Any code in 'Treatment-SRS-Brain'
...
describe('checkSurgicalProcedureFilterLogic', () => {
  ...
  it('Test Resection Filter', () => {
    const surgicalValue = createSurgicalBundle({
      system: 'http://snomed.info/sct',
      code: '446103006',
      display: 'N/A'
    } as Coding); // Any code in 'Treatment-Resection-Brain'
  ...
  it('Test Splenectomy Filter', () => {
    const surgicalValue = createSurgicalBundle({
      ...
      code: '67097003',
      display: 'N/A'
    } as Coding); // Any code in 'Treatment-Splenectomy'
  ...
  it('Test Bone Marrow Transplant Filter', () => {
    const surgicalValue = createSurgicalBundle({
      ...
      code: '58390007',
      display: 'N/A'
    } as Coding); // One specific Code for Bone Marrow Transplant
  ...
  it('Test Organ Transplant Filter', () => {
    const surgicalValue = createSurgicalBundle({
      ...
      code: '765478004',
      display: 'N/A'
    } as Coding); // Any code in 'Treatment-Organ_Transplant'
...
describe('checkTumorMarkerFilterLogic', () => {
  ...
  it('Test ER+ and HER- and FGFR Amplifications Filter', () => {
    ...
    expect(createTumorMarkerValues(tumorMarker1, tumorMarker2, tumorMarker3)).toBe(
      'ER_PLUS_AND_HER2_MINUS_AND_FGFR_AMPLIFICATIONS'
    );
  });
  ...
  it('Test PR+ and HER- and FGFR Amplifications Filter', () => {
    ...
    expect(createTumorMarkerValues(tumorMarker1, tumorMarker2, tumorMarker3)).toBe(
      'PR_PLUS_AND_HER2_MINUS_AND_FGFR_AMPLIFICATIONS'
    );
  });
  ...
  it('Test Triple negative and RB Positive Filter', () => {
    ...
    expect(createTumorMarkerValues(tumorMarker1, tumorMarker2, tumorMarker3, tumorMarker4)).toBe(
      'TRIPLE_NEGATIVE_AND_RB_POSITIVE'
    );
  });

  const createCgvTumorMarkerValues = (
    cgvGeneStudiedVcc: Coding,
    cgvGeneStudiedInterpretation: Coding,
    cgvGenomicSourceClassVcc: Coding,
    cgvValueCodeableConcepts: Coding[],
    cgvInterpretation: Coding
  ): string => {
    const mappingLogic = new TrialscopeMappingLogic(
      createCgvTumorMarkerBundle(
        cgvGeneStudiedVcc,
        cgvGeneStudiedInterpretation,
        cgvGenomicSourceClassVcc,
        cgvValueCodeableConcepts,
        cgvInterpretation
      )
    );
    return mappingLogic.getTumorMarkerValues();
  ...
  const createCgvTumorMarkerBundle = (
    cgvGeneStudiedVcc: Coding,
    cgvGeneStudiedInterpretation: Coding,
    cgvGenomicSourceClassVcc: Coding,
    cgvValueCodeableConcepts: Coding[],
  ...
  it('Test BRCA2-Somatic Filter', () => {
    ...
    const cgvGenomicSourceClassVcc = { system: ' http://loinc.info/sct', code: 'LA6684-0', display: 'N/A' };
    expect(
      createCgvTumorMarkerValues(cgvGeneStudiedVcc, undefined, cgvGenomicSourceClassVcc, undefined, cgvInterpretation)
    ).toBe('BRCA2-SOMATIC');
  });
  ...
  it('Test BRCA1 Filter', () => {
    ...
    expect(
      createCgvTumorMarkerValues(cgvGeneStudiedVcc, cgvGeneStudiedInterpretation, undefined, undefined, undefined)
    ).toBe('BRCA1');
  });
  ...
  it('Test BRCA2 Filter', () => {
    ...
    expect(createCgvTumorMarkerValues(cgvGeneStudiedVcc, undefined, undefined, undefined, cgvInterpretation)).toBe(
      'BRCA2'
    );
  });
